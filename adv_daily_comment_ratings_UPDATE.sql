DELIMITER $$
CREATE PROCEDURE `adv_daily_comment_ratings_UPDATE`()
BEGIN
DROP TABLE IF EXISTS adv_daily_comment_ratings;

CREATE TABLE adv_daily_comment_ratings AS
	SELECT
		n.runner_id,
