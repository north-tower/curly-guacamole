...
CREATE DEFINER=`smartform_user`@`localhost` PROCEDURE `separated_comments_win_value_UPDATE`()
BEGIN
    ...
    CREATE TABLE separated_comments_win_value as
        ...
        FROM
            coolwed1_WP9PN.separated_comment_count scc
        JOIN coolwed1_WP9PN.separated_comments sc
