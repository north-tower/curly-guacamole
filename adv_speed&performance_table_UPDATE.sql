...
BEGIN
	...
	SELECT 
		...
		`asa`.`DF_5` AS `DF_5`,
		`asa`.`DF_6` AS `DF_6`,
		`asa`.`going_LTO` AS `going_LTO`,
		`asa`.`going_1` AS `going_1`,
		`asa`.`going_2` AS `going_2`,
		`asa`.`going_3` AS `going_3`,
		`asa`.`going_4` AS `going_4`,
		`asa`.`going_5` AS `going_5`,
		`asa`.`going_6` AS `going_6`,
